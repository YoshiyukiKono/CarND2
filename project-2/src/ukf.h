...
public:
  ...
  //* Augumented sigma points matrix
  MatrixXd Xsig_aug_;
  
  //* Augumented state vector: [pos1 pos2 vel_abs yaw_angle yaw_rate] in SI units and rad
  VectorXd x_aug_;
  
  //* Augumented state covariance matrix
  MatrixXd P_aug_;
  
  //* Incomming radar measurements vector
  VectorXd z_radar_;
  //* Incomming laser measurements vector
  VectorXd z_laser_;
